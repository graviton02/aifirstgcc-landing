...
const bottomCards = [
  ...
  {
    title: "AI Advisor Network",
    description: "Get matched with vetted AI advisors — strategy, engineering, data platform, and governance experts.",
    image: "/images/icons/ai-advisors.webp",
    href: "/advisors",
    linkText: "Meet advisors",
  },
]
