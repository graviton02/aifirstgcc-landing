    ...
    <div className="p-4 bg-white border border-enterprise-200 rounded-xl">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <Bot className="w-4 h-4 text-enterprise-400 shrink-0" />
            <p className="font-medium text-enterprise-900">
              {edit.agent?.agent_name ?? "Unknown Agent"}
            </p>
      ...
      {expanded && (
        <div className="mt-4 border-t border-enterprise-100 pt-4">
          <PendingEditDiff currentRecord={edit.agent} payload={payload} />
        </div>
      )}
      ...
      {view === "pending" && (
        <>
          {edits === undefined ? (
            ...
            <p className="text-enterprise-500 py-8 text-center">No pending agent edits.</p>
          ) : (
